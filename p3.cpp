...
std::ifstream file("C:/Users/karet/Downloads/example.txt");
...
#pragma omp critical
{
	...
	int countToShow = std::min(5, static_cast<int>(wordVector.size()));
	for (int i = 0; i < countToShow; ++i) {
		std::cout << wordVector[i].first << ": " << wordVector[i].second << " times" << std::endl;
	}
